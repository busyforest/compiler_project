...
bb_while_5_36_cond:                               ; preds = %bb_if_9_38_end, %bb_while_5_16_bre
  %r125 = load i32, ptr %r100, align 4
  %r126 = icmp slt i32 %r125, 10
  br i1 %r126, label %bb22_36_next, label %bb_while_5_36_bre

bb22_36_next:                                     ; preds = %bb_while_5_36_cond
  %r127 = load i32, ptr %r123, align 4
  %r128 = icmp eq i32 %r127, 0
  br i1 %r128, label %bb_while_5_36_whilestms, label %bb_while_5_36_bre

bb_while_5_36_whilestms:                          ; preds = %bb22_36_next
  %r129 = load i32, ptr %r100, align 4
  %r130 = getelementptr [10 x i32], ptr %r102, i32 0, i32 %r129
  %r131 = load i32, ptr %r130, align 4
  %r132 = load i32, ptr %r111, align 4
  %r133 = icmp eq i32 %r131, %r132
  br i1 %r133, label %bb_if_9_38_true, label %bb_if_9_38_false

bb_if_9_38_true:                                  ; preds = %bb_while_5_36_whilestms
  store i32 1, ptr %r123, align 4
  %r134 = load i32, ptr %r100, align 4
  store i32 %r134, ptr %r124, align 4
  br label %bb_if_9_38_end

bb_if_9_38_false:                                 ; preds = %bb_while_5_36_whilestms
  br label %bb_if_9_38_end

bb_if_9_38_end:                                   ; preds = %bb_if_9_38_false, %bb_if_9_38_true
  %r135 = load i32, ptr %r100, align 4
  %r136 = add i32 %r135, 1
  store i32 %r136, ptr %r100, align 4
  br label %bb_while_5_36_cond

bb_while_5_36_bre:                                ; preds = %bb22_36_next, %bb_while_5_36_cond
  %r137 = load i32, ptr %r123, align 4
  %r138 = icmp eq i32 %r137, 1
  br i1 %r138, label %bb_if_5_47_true, label %bb_if_5_47_false

bb_if_5_47_true:                                  ; preds = %bb_while_5_36_bre
  %r139 = load i32, ptr %r124, align 4
  call void @putint(i32 %r139)
  br label %bb_if_5_47_end

bb_if_5_47_false:                                 ; preds = %bb_while_5_36_bre
  store i32 0, ptr %r111, align 4
  %r140 = load i32, ptr %r111, align 4
  call void @putint(i32 %r140)
  br label %bb_if_5_47_end

bb_if_5_47_end:                                   ; preds = %bb_if_5_47_false, %bb_if_5_47_true
  store i32 10, ptr %r111, align 4
  %r141 = load i32, ptr %r111, align 4
