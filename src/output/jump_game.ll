...
bb_if_5_10_true:                                  ; preds = %bb1
  ret i32 1

bb_if_5_10_false:                                 ; preds = %bb1
...
bb_if_5_14_true:                                  ; preds = %bb_if_5_10_end
  ret i32 1

bb_if_5_14_false:                                 ; preds = %bb_if_5_10_end
  br label %bb_if_5_14_end

bb_if_5_14_end:                                   ; preds = %bb_if_5_14_false
  store i32 0, ptr %r111, align 4
  br label %bb_while_5_21_cond

bb_while_5_21_cond:                               ; preds = %bb_while_5_21_whilestms, %bb_if_5_14_end
...
bb_while_5_21_whilestms:                          ; preds = %bb_while_5_21_cond
...
bb_while_5_21_bre:                                ; preds = %bb_while_5_21_cond
...
bb_while_5_28_cond:                               ; preds = %bb_while_9_37_bre, %bb_while_5_21_bre
...
bb_if_9_30_true:                                  ; preds = %bb_while_5_28_whilestms
...
bb_if_9_30_false:                                 ; preds = %bb_while_5_28_whilestms
...
bb_if_9_30_end:                                   ; preds = %bb_if_9_30_false, %bb_if_9_30_true
  br label %bb_while_9_37_cond

bb_while_9_37_cond:                               ; preds = %bb_if_13_39_end, %bb_if_9_30_end
  %r145 = load i32, ptr %r129, align 4
  %r146 = icmp sgt i32 %r145, -1
  br i1 %r146, label %bb_while_9_37_whilestms, label %bb_while_9_37_bre

bb_while_9_37_whilestms:                          ; preds = %bb_while_9_37_cond
...
bb_if_13_39_true:                                 ; preds = %bb_while_9_37_whilestms
...
bb_if_13_39_false:                                ; preds = %bb_while_9_37_whilestms
  br label %bb_if_13_39_end
...
bb_while_9_37_bre:                                ; preds = %bb_while_9_37_cond
...
bb2:
  ...
  %r174 = getelementptr [10 x i32], ptr %r163, i32 0, i32 0
  %r175 = load i32, ptr %r162, align 4
  %r176 = call i32 @canJump(ptr %r174, i32 %r175)
  store i32 %r176, ptr %r162, align 4
  %r177 = load i32, ptr %r162, align 4
  ret i32 %r177
}
