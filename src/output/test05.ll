...
bb_while_5_19_cond:                               ; preds = %bb_if_9_21_end, %bb1
  %r104 = load i32, ptr %r102, align 4
  %r105 = load i32, ptr %r101, align 4
  %r106 = add i32 %r105, 1
  %r107 = icmp slt i32 %r104, %r106
  br i1 %r107, label %bb_while_5_19_whilestms, label %bb_while_5_19_bre

bb_while_5_19_whilestms:                          ; preds = %bb_while_5_19_cond
  ...
  br i1 %r114, label %bb_if_9_21_true, label %bb_if_9_21_false

bb_if_9_21_true:                                  ; preds = %bb_while_5_19_whilestms
  %r115 = load i32, ptr %r103, align 4
  %r116 = load i32, ptr %r102, align 4
  %r117 = add i32 %r115, %r116
  store i32 %r117, ptr %r103, align 4
  br label %bb_if_9_21_end

bb_if_9_21_false:                                 ; preds = %bb_while_5_19_whilestms
  br label %bb_if_9_21_end

bb_if_9_21_end:                                   ; preds = %bb_if_9_21_false, %bb_if_9_21_true
  %r118 = load i32, ptr %r102, align 4
  %r119 = add i32 %r118, 1
  store i32 %r119, ptr %r102, align 4
  br label %bb_while_5_19_cond

bb_while_5_19_bre:                                ; preds = %bb_while_5_19_cond
