...
bb_while_5_16_cond:                               ; preds = %bb_while_5_16_whilestms, %bb1
  %r103 = load i32, ptr %r100, align 4
  %r104 = icmp slt i32 %r103, 10
  br i1 %r104, label %bb_while_5_16_whilestms, label %bb_while_5_16_bre

bb_while_5_16_whilestms:                          ; preds = %bb_while_5_16_cond
  %r105 = load i32, ptr %r100, align 4
  %r106 = getelementptr [10 x i32], ptr %r102, i32 0, i32 %r105
...
bb_while_5_16_bre:                                ; preds = %bb_while_5_16_cond
...
bb_while_5_31_cond:                               ; preds = %bb_if_9_34_end, %bb_while_5_16_bre
  %r123 = load i32, ptr %r114, align 4
  %r124 = getelementptr [10 x i32], ptr %r102, i32 0, i32 %r123
  %r125 = load i32, ptr %r124, align 4
  %r126 = load i32, ptr %r111, align 4
  %r127 = icmp ne i32 %r125, %r126
  br i1 %r127, label %bb27_31_next, label %bb_while_5_31_bre

bb27_31_next:                                     ; preds = %bb_while_5_31_cond
  %r128 = load i32, ptr %r113, align 4
  %r129 = load i32, ptr %r112, align 4
  %r130 = icmp slt i32 %r128, %r129
  br i1 %r130, label %bb_while_5_31_whilestms, label %bb_while_5_31_bre

bb_while_5_31_whilestms:                          ; preds = %bb27_31_next
  %r131 = load i32, ptr %r112, align 4
  %r132 = load i32, ptr %r113, align 4
  %r133 = add i32 %r131, %r132
  %r134 = sdiv i32 %r133, 2
  store i32 %r134, ptr %r114, align 4
  %r135 = load i32, ptr %r111, align 4
  %r136 = load i32, ptr %r114, align 4
  %r137 = getelementptr [10 x i32], ptr %r102, i32 0, i32 %r136
  %r138 = load i32, ptr %r137, align 4
  %r139 = icmp slt i32 %r135, %r138
  br i1 %r139, label %bb_if_9_34_true, label %bb_if_9_34_false

bb_if_9_34_true:                                  ; preds = %bb_while_5_31_whilestms
  %r140 = load i32, ptr %r114, align 4
  %r141 = sub i32 %r140, 1
  store i32 %r141, ptr %r112, align 4
  br label %bb_if_9_34_end

bb_if_9_34_false:                                 ; preds = %bb_while_5_31_whilestms
  %r142 = load i32, ptr %r114, align 4
  %r143 = add i32 %r142, 1
  store i32 %r143, ptr %r113, align 4
  br label %bb_if_9_34_end

bb_if_9_34_end:                                   ; preds = %bb_if_9_34_false, %bb_if_9_34_true
  br label %bb_while_5_31_cond

bb_while_5_31_bre:                                ; preds = %bb27_31_next, %bb_while_5_31_cond
  %r144 = load i32, ptr %r111, align 4
  %r145 = load i32, ptr %r114, align 4
  %r146 = getelementptr [10 x i32], ptr %r102, i32 0, i32 %r145
  %r147 = load i32, ptr %r146, align 4
  %r148 = icmp eq i32 %r144, %r147
  br i1 %r148, label %bb_if_5_44_true, label %bb_if_5_44_false

bb_if_5_44_true:                                  ; preds = %bb_while_5_31_bre
  %r149 = load i32, ptr %r111, align 4
  call void @putint(i32 %r149)
  br label %bb_if_5_44_end

bb_if_5_44_false:                                 ; preds = %bb_while_5_31_bre
  store i32 0, ptr %r111, align 4
  %r150 = load i32, ptr %r111, align 4
  call void @putint(i32 %r150)
  br label %bb_if_5_44_end

bb_if_5_44_end:                                   ; preds = %bb_if_5_44_false, %bb_if_5_44_true
