...
bb_while_5_15_cond:                               ; preds = %bb_if_9_17_end, %bb_if_9_17_true, %bb1
  %r102 = icmp sgt i32 1, 0
  br i1 %r102, label %bb_while_5_15_whilestms, label %bb_while_5_15_bre
...
bb_while_5_15_whilestms:                          ; preds = %bb_while_5_15_cond
  ...
  br i1 %r107, label %bb_if_9_17_true, label %bb25_17_next

bb25_17_next:                                     ; preds = %bb_while_5_15_whilestms
  %r108 = load i32, ptr %r101, align 4
  %r109 = icmp sgt i32 %r108, 9
  br i1 %r109, label %bb_if_9_17_true, label %bb_if_9_17_false

bb_if_9_17_true:                                  ; preds = %bb25_17_next, %bb_while_5_15_whilestms
  br label %bb_while_5_15_cond

bb_if_9_17_false:                                 ; preds = %bb25_17_next
  br label %bb_while_5_15_bre

bb_if_9_17_end:                                   ; No predecessors!
  br label %bb_while_5_15_cond

bb_while_5_15_bre:                                ; preds = %bb_if_9_17_false, %bb_while_5_15_cond
  %r110 = load i32, ptr %r101, align 4
  store i32 %r110, ptr %r100, align 4
  br label %bb_while_5_25_cond

bb_while_5_25_cond:                               ; preds = %bb_if_9_27_end, %bb_while_5_15_bre
  %r111 = icmp sgt i32 1, 0
  br i1 %r111, label %bb_while_5_25_whilestms, label %bb_while_5_25_bre

bb_while_5_25_whilestms:                          ; preds = %bb_while_5_25_cond
  %r112 = call i32 @getch()
  ...
  br i1 %r116, label %bb26_27_next, label %bb_if_9_27_false

bb26_27_next:                                     ; preds = %bb_while_5_25_whilestms
  %r117 = load i32, ptr %r101, align 4
  %r118 = icmp sle i32 %r117, 9
  br i1 %r118, label %bb_if_9_27_true, label %bb_if_9_27_false

bb_if_9_27_true:                                  ; preds = %bb26_27_next
...
bb_if_9_27_false:                                 ; preds = %bb26_27_next, %bb_while_5_25_whilestms
  br label %bb_while_5_25_bre

bb_if_9_27_end:                                   ; preds = %bb_if_9_27_true
  br label %bb_while_5_25_cond

bb_while_5_25_bre:                                ; preds = %bb_if_9_27_false, %bb_while_5_25_cond
...
bb_while_5_46_cond:                               ; preds = %bb_while_5_46_whilestms, %bb3
  %r139 = load i32, ptr %r136, align 4
  %r140 = icmp sgt i32 %r139, 0
  br i1 %r140, label %bb_while_5_46_whilestms, label %bb_while_5_46_bre

bb_while_5_46_whilestms:                          ; preds = %bb_while_5_46_cond
...
bb_while_5_46_bre:                                ; preds = %bb_while_5_46_cond
  br label %bb_while_5_51_cond

bb_while_5_51_cond:                               ; preds = %bb_while_5_51_whilestms, %bb_while_5_46_bre
  %r151 = load i32, ptr %r138, align 4
  %r152 = icmp sgt i32 %r151, 0
  br i1 %r152, label %bb_while_5_51_whilestms, label %bb_while_5_51_bre
...
bb4:
  ...
  br label %bb_while_5_60_cond

bb_while_5_60_cond:                               ; preds = %bb_while_5_60_whilestms, %bb4
  %r160 = load i32, ptr %r158, align 4
  %r161 = icmp sgt i32 %r160, 0
  br i1 %r161, label %bb_while_5_60_whilestms, label %bb_while_5_60_bre

bb_while_5_60_whilestms:                          ; preds = %bb_while_5_60_cond
...
bb_while_5_60_bre:                                ; preds = %bb_while_5_60_cond
  ret i32 0
}
