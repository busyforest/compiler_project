...
bb_while_5_26_cond:                               ; preds = %bb_while_5_26_whilestms, %bb1
  %r101 = load i32, ptr %r100, align 4
  %r102 = load i32, ptr @n, align 4
  %r103 = icmp sle i32 %r101, %r102
  br i1 %r103, label %bb_while_5_26_whilestms, label %bb_while_5_26_bre

bb_while_5_26_whilestms:                          ; preds = %bb_while_5_26_cond
...
bb_while_5_26_bre:                                ; preds = %bb_while_5_26_cond
  %r115 = getelementptr [16 x i32], ptr @book, i32 0, i32 1
  store i32 1, ptr %r115, align 4
  store i32 1, ptr %r100, align 4
  br label %bb_while_5_34_cond

bb_while_5_34_cond:                               ; preds = %bb_while_9_47_bre, %bb_while_5_26_bre
  %r116 = load i32, ptr %r100, align 4
  %r117 = load i32, ptr @n, align 4
  %r118 = sub i32 %r117, 1
  %r119 = icmp sle i32 %r116, %r118
  br i1 %r119, label %bb_while_5_34_whilestms, label %bb_while_5_34_bre

bb_while_5_34_whilestms:                          ; preds = %bb_while_5_34_cond
  %r121 = load i32, ptr @INF, align 4
  store i32 %r121, ptr %r120, align 4
  store i32 0, ptr %r122, align 4
  store i32 1, ptr %r123, align 4
  br label %bb_while_9_38_cond

bb_while_9_38_cond:                               ; preds = %bb_if_13_39_end, %bb_while_5_34_whilestms
  %r124 = load i32, ptr %r123, align 4
  %r125 = load i32, ptr @n, align 4
  %r126 = icmp sle i32 %r124, %r125
  br i1 %r126, label %bb_while_9_38_whilestms, label %bb_while_9_38_bre

bb_while_9_38_whilestms:                          ; preds = %bb_while_9_38_cond
  ...
  br i1 %r131, label %bb40_39_next, label %bb_if_13_39_false

bb40_39_next:                                     ; preds = %bb_while_9_38_whilestms
  ...
  br i1 %r135, label %bb_if_13_39_true, label %bb_if_13_39_false

bb_if_13_39_true:                                 ; preds = %bb40_39_next
...
bb_if_13_39_false:                                ; preds = %bb40_39_next, %bb_while_9_38_whilestms
  br label %bb_if_13_39_end

bb_if_13_39_end:                                  ; preds = %bb_if_13_39_false, %bb_if_13_39_true
  %r140 = load i32, ptr %r123, align 4
  %r141 = add i32 %r140, 1
  store i32 %r141, ptr %r123, align 4
  br label %bb_while_9_38_cond

bb_while_9_38_bre:                                ; preds = %bb_while_9_38_cond
...
bb_while_9_47_cond:                               ; preds = %bb_if_13_48_end, %bb_while_9_38_bre
  %r145 = load i32, ptr %r144, align 4
  %r146 = load i32, ptr @n, align 4
  %r147 = icmp sle i32 %r145, %r146
  br i1 %r147, label %bb_while_9_47_whilestms, label %bb_while_9_47_bre

bb_while_9_47_whilestms:                          ; preds = %bb_while_9_47_cond
  ...
  br i1 %r155, label %bb_if_13_48_true, label %bb_if_13_48_false

bb_if_13_48_true:                                 ; preds = %bb_while_9_47_whilestms
  ...
  br i1 %r169, label %bb_if_17_49_true, label %bb_if_17_49_false

bb_if_17_49_true:                                 ; preds = %bb_if_13_48_true
  ...
  br label %bb_if_17_49_end

bb_if_17_49_false:                                ; preds = %bb_if_13_48_true
  br label %bb_if_17_49_end

bb_if_17_49_end:                                  ; preds = %bb_if_17_49_false, %bb_if_17_49_true
  br label %bb_if_13_48_end

bb_if_13_48_false:                                ; preds = %bb_while_9_47_whilestms
  br label %bb_if_13_48_end

bb_if_13_48_end:                                  ; preds = %bb_if_13_48_false, %bb_if_17_49_end
  %r182 = load i32, ptr %r144, align 4
  %r183 = add i32 %r182, 1
  store i32 %r183, ptr %r144, align 4
  br label %bb_while_9_47_cond

bb_while_9_47_bre:                                ; preds = %bb_while_9_47_cond
  %r184 = load i32, ptr %r100, align 4
  %r185 = add i32 %r184, 1
  store i32 %r185, ptr %r100, align 4
  br label %bb_while_5_34_cond

bb_while_5_34_bre:                                ; preds = %bb_while_5_34_cond
  ret void
}
...
bb2:
  ...
  br label %bb_while_5_66_cond

bb_while_5_66_cond:                               ; preds = %bb_while_9_68_bre, %bb2
  %r189 = load i32, ptr %r186, align 4
  %r190 = load i32, ptr @n, align 4
  %r191 = icmp sle i32 %r189, %r190
  br i1 %r191, label %bb_while_5_66_whilestms, label %bb_while_5_66_bre

bb_while_5_66_whilestms:                          ; preds = %bb_while_5_66_cond
  store i32 1, ptr %r192, align 4
  br label %bb_while_9_68_cond

bb_while_9_68_cond:                               ; preds = %bb_if_13_69_end, %bb_while_5_66_whilestms
  %r193 = load i32, ptr %r192, align 4
  %r194 = load i32, ptr @n, align 4
  %r195 = icmp sle i32 %r193, %r194
  br i1 %r195, label %bb_while_9_68_whilestms, label %bb_while_9_68_bre

bb_while_9_68_whilestms:                          ; preds = %bb_while_9_68_cond
  %r196 = load i32, ptr %r186, align 4
  %r197 = load i32, ptr %r192, align 4
  %r198 = icmp eq i32 %r196, %r197
  br i1 %r198, label %bb_if_13_69_true, label %bb_if_13_69_false

bb_if_13_69_true:                                 ; preds = %bb_while_9_68_whilestms
  ...
  br label %bb_if_13_69_end

bb_if_13_69_false:                                ; preds = %bb_while_9_68_whilestms
...
bb_if_13_69_end:                                  ; preds = %bb_if_13_69_false, %bb_if_13_69_true
  %r210 = load i32, ptr %r192, align 4
  %r211 = add i32 %r210, 1
  store i32 %r211, ptr %r192, align 4
  br label %bb_while_9_68_cond

bb_while_9_68_bre:                                ; preds = %bb_while_9_68_cond
  %r212 = load i32, ptr %r186, align 4
  %r213 = add i32 %r212, 1
  store i32 %r213, ptr %r186, align 4
  br label %bb_while_5_66_cond

bb_while_5_66_bre:                                ; preds = %bb_while_5_66_cond
  store i32 1, ptr %r186, align 4
  br label %bb_while_5_83_cond

bb_while_5_83_cond:                               ; preds = %bb_while_5_83_whilestms, %bb_while_5_66_bre
  %r214 = load i32, ptr %r186, align 4
  %r215 = load i32, ptr @m, align 4
  %r216 = icmp sle i32 %r214, %r215
  br i1 %r216, label %bb_while_5_83_whilestms, label %bb_while_5_83_bre

bb_while_5_83_whilestms:                          ; preds = %bb_while_5_83_cond
...
bb_while_5_83_bre:                                ; preds = %bb_while_5_83_cond
  call void @Dijkstra()
  store i32 1, ptr %r186, align 4
  br label %bb_while_5_93_cond

bb_while_5_93_cond:                               ; preds = %bb_while_5_93_whilestms, %bb_while_5_83_bre
  %r229 = load i32, ptr %r186, align 4
  %r230 = load i32, ptr @n, align 4
  %r231 = icmp sle i32 %r229, %r230
  br i1 %r231, label %bb_while_5_93_whilestms, label %bb_while_5_93_bre

bb_while_5_93_whilestms:                          ; preds = %bb_while_5_93_cond
...
bb_while_5_93_bre:                                ; preds = %bb_while_5_93_cond
