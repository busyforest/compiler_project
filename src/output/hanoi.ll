...
bb2:
  ...
  %r114 = load i32, ptr %r107, align 4
  %r115 = icmp eq i32 %r114, 1
  br i1 %r115, label %bb_if_5_16_true, label %bb_if_5_16_false

bb_if_5_16_true:                                  ; preds = %bb2
  %r116 = load i32, ptr %r109, align 4
  %r117 = load i32, ptr %r113, align 4
  call void @move(i32 %r116, i32 %r117)
  br label %bb_if_5_16_end

bb_if_5_16_false:                                 ; preds = %bb2
  %r118 = load i32, ptr %r107, align 4
  %r119 = sub i32 %r118, 1
  %r120 = load i32, ptr %r109, align 4
  %r121 = load i32, ptr %r113, align 4
  %r122 = load i32, ptr %r111, align 4
  call void @hanoi(i32 %r119, i32 %r120, i32 %r121, i32 %r122)
  %r123 = load i32, ptr %r109, align 4
  %r124 = load i32, ptr %r113, align 4
  call void @move(i32 %r123, i32 %r124)
  %r125 = load i32, ptr %r107, align 4
  %r126 = sub i32 %r125, 1
  %r127 = load i32, ptr %r111, align 4
  %r128 = load i32, ptr %r109, align 4
  %r129 = load i32, ptr %r113, align 4
  call void @hanoi(i32 %r126, i32 %r127, i32 %r128, i32 %r129)
  br label %bb_if_5_16_end

bb_if_5_16_end:                                   ; preds = %bb_if_5_16_false, %bb_if_5_16_true
  ret void
}
...
bb3:
  ...
  store i32 %r131, ptr %r130, align 4
  br label %bb_while_5_30_cond

bb_while_5_30_cond:                               ; preds = %bb_while_5_30_whilestms, %bb3
  %r132 = load i32, ptr %r130, align 4
  %r133 = icmp sgt i32 %r132, 0
  br i1 %r133, label %bb_while_5_30_whilestms, label %bb_while_5_30_bre

bb_while_5_30_whilestms:                          ; preds = %bb_while_5_30_cond
  %r134 = call i32 @getint()
  call void @hanoi(i32 %r134, i32 1, i32 2, i32 3)
  call void @putch(i32 10)
  %r135 = load i32, ptr %r130, align 4
  %r136 = sub i32 %r135, 1
  store i32 %r136, ptr %r130, align 4
  br label %bb_while_5_30_cond

bb_while_5_30_bre:                                ; preds = %bb_while_5_30_cond
  ret i32 0
}
