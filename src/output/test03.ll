...
bb_while_5_13_bre:                                ; preds = %bb_while_5_13_cond
  ret void
}
...
bb2:
  ...
  %r111 = getelementptr [10 x i32], ptr @b, i32 0, i32 0
  call void @foo(ptr %r111)
  br label %bb_while_5_25_cond

bb_while_5_25_cond:                               ; preds = %bb_while_5_25_whilestms, %bb2
...
bb_while_5_25_whilestms:                          ; preds = %bb_while_5_25_cond
  ...
  %r115 = load i32, ptr %r109, align 4
  %r116 = getelementptr [10 x i32], ptr @b, i32 0, i32 %r115
  %r117 = load i32, ptr %r116, align 4
  %r118 = add i32 %r114, %r117
  store i32 %r118, ptr %r110, align 4
  %r119 = load i32, ptr %r109, align 4
  %r120 = add i32 %r119, 1
  store i32 %r120, ptr %r109, align 4
  br label %bb_while_5_25_cond

bb_while_5_25_bre:                                ; preds = %bb_while_5_25_cond
  %r121 = getelementptr [10 x i32], ptr @b, i32 0, i32 0
  call void @putarray(i32 10, ptr %r121)
  %r122 = load i32, ptr %r110, align 4
