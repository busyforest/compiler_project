...
bb3:
  ...
  call void @foo(ptr @d)
  %r115 = getelementptr [10 x %Node], ptr @e, i32 0, i32 0
  call void @baz(ptr %r115)
  %r116 = getelementptr %Node, ptr %r112, i32 0, i32 0
  %r117 = load i32, ptr %r116, align 4
  %r118 = getelementptr %Node, ptr %r112, i32 0, i32 1
  %r119 = load i32, ptr %r118, align 4
  %r120 = add i32 %r117, %r119
  call void @putint(i32 %r120)
  %r121 = getelementptr %Node, ptr @d, i32 0, i32 0
  %r122 = load i32, ptr %r121, align 4
  %r123 = getelementptr %Node, ptr @d, i32 0, i32 1
  %r124 = load i32, ptr %r123, align 4
  %r125 = add i32 %r122, %r124
  call void @putint(i32 %r125)
  %r126 = getelementptr [10 x %Node], ptr @e, i32 0, i32 2
  %r127 = getelementptr %Node, ptr %r126, i32 0, i32 0
  %r128 = load i32, ptr %r127, align 4
  %r129 = getelementptr [10 x %Node], ptr @e, i32 0, i32 2
  %r130 = getelementptr %Node, ptr %r129, i32 0, i32 1
