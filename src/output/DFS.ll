...
bb_while_5_51_cond:                               ; preds = %bb_while_5_51_whilestms, %bb3
  %r157 = load i32, ptr %r156, align 4
  %r158 = icmp slt i32 %r157, 1005
  br i1 %r158, label %bb_while_5_51_whilestms, label %bb_while_5_51_bre

bb_while_5_51_whilestms:                          ; preds = %bb_while_5_51_cond
...
bb_while_5_51_bre:                                ; preds = %bb_while_5_51_cond
  ret void
}
...
bb_while_5_59_cond:                               ; preds = %bb_while_5_59_whilestms, %bb4
  %r165 = load i32, ptr %r164, align 4
  %r166 = load i32, ptr @n, align 4
  %r167 = icmp sle i32 %r165, %r166
  br i1 %r167, label %bb_while_5_59_whilestms, label %bb_while_5_59_bre

bb_while_5_59_whilestms:                          ; preds = %bb_while_5_59_cond
...
bb_while_5_59_bre:                                ; preds = %bb_while_5_59_cond
  ret void
}
...
bb5:
  ...
  br i1 %r180, label %bb_if_5_67_true, label %bb_if_5_67_false

bb_if_5_67_true:                                  ; preds = %bb5
  ret i32 1

bb_if_5_67_false:                                 ; preds = %bb5
  br label %bb_if_5_67_end

bb_if_5_67_end:                                   ; preds = %bb_if_5_67_false
  ...
  br label %bb_while_5_71_cond

bb_while_5_71_cond:                               ; preds = %bb_if_9_73_end, %bb_if_5_67_end
  %r185 = load i32, ptr %r181, align 4
  %r186 = sub i32 0, 1
  %r187 = icmp ne i32 %r185, %r186
  br i1 %r187, label %bb_while_5_71_whilestms, label %bb_while_5_71_bre

bb_while_5_71_whilestms:                          ; preds = %bb_while_5_71_cond
  ...
  br i1 %r195, label %bb29_73_next, label %bb_if_9_73_false

bb29_73_next:                                     ; preds = %bb_while_5_71_whilestms
  %r196 = load i32, ptr %r188, align 4
  %r197 = load i32, ptr %r175, align 4
  %r198 = call i32 @same(i32 %r196, i32 %r197)
  %r199 = icmp ne i32 %r198, 0
  br i1 %r199, label %bb_if_9_73_true, label %bb_if_9_73_false

bb_if_9_73_true:                                  ; preds = %bb29_73_next
  ret i32 1

bb_if_9_73_false:                                 ; preds = %bb29_73_next, %bb_while_5_71_whilestms
  br label %bb_if_9_73_end

bb_if_9_73_end:                                   ; preds = %bb_if_9_73_false
...
bb_while_5_71_bre:                                ; preds = %bb_while_5_71_cond
  ret i32 0
}
...
bb_while_5_87_cond:                               ; preds = %bb_if_9_92_end, %bb6
  %r208 = load i32, ptr @m, align 4
  %r209 = icmp ne i32 %r208, 0
  br i1 %r209, label %bb_while_5_87_whilestms, label %bb_while_5_87_bre

bb_while_5_87_whilestms:                          ; preds = %bb_while_5_87_cond
  %r210 = call i32 @getch()
  store i32 %r210, ptr %r205, align 4
  br label %bb_while_9_89_cond

bb_while_9_89_cond:                               ; preds = %bb_while_9_89_whilestms, %bb_while_5_87_whilestms
  %r211 = load i32, ptr %r205, align 4
  %r212 = icmp ne i32 %r211, 81
  br i1 %r212, label %bb31_89_next, label %bb_while_9_89_bre

bb31_89_next:                                     ; preds = %bb_while_9_89_cond
  %r213 = load i32, ptr %r205, align 4
  %r214 = icmp ne i32 %r213, 85
  br i1 %r214, label %bb_while_9_89_whilestms, label %bb_while_9_89_bre

bb_while_9_89_whilestms:                          ; preds = %bb31_89_next
  %r215 = call i32 @getch()
  store i32 %r215, ptr %r205, align 4
  br label %bb_while_9_89_cond

bb_while_9_89_bre:                                ; preds = %bb31_89_next, %bb_while_9_89_cond
  %r216 = load i32, ptr %r205, align 4
  %r217 = icmp eq i32 %r216, 81
  br i1 %r217, label %bb_if_9_92_true, label %bb_if_9_92_false

bb_if_9_92_true:                                  ; preds = %bb_while_9_89_bre
  ...
  br label %bb_if_9_92_end

bb_if_9_92_false:                                 ; preds = %bb_while_9_89_bre
...
bb_if_9_92_end:                                   ; preds = %bb_if_9_92_false, %bb_if_9_92_true
  %r227 = load i32, ptr @m, align 4
  %r228 = sub i32 %r227, 1
  store i32 %r228, ptr @m, align 4
  br label %bb_while_5_87_cond

bb_while_5_87_bre:                                ; preds = %bb_while_5_87_cond
  ret i32 0
}
