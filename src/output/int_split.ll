...
bb_while_5_22_cond:                               ; preds = %bb_while_5_22_whilestms, %bb2
...
bb3:
  ...
  %r131 = getelementptr [4 x i32], ptr %r129, i32 0, i32 0
  %r132 = call i32 @split(i32 %r130, ptr %r131)
  store i32 %r132, ptr %r128, align 4
  %r133 = alloca i32, align 4
  store i32 0, ptr %r127, align 4
  br label %bb_while_5_43_cond

bb_while_5_43_cond:                               ; preds = %bb_while_5_43_whilestms, %bb3
  %r134 = load i32, ptr %r127, align 4
  %r135 = icmp slt i32 %r134, 4
  br i1 %r135, label %bb_while_5_43_whilestms, label %bb_while_5_43_bre

bb_while_5_43_whilestms:                          ; preds = %bb_while_5_43_cond
  %r136 = load i32, ptr %r127, align 4
  %r137 = getelementptr [4 x i32], ptr %r129, i32 0, i32 %r136
  ...
  %r141 = load i32, ptr %r127, align 4
  %r142 = add i32 %r141, 1
  store i32 %r142, ptr %r127, align 4
  br label %bb_while_5_43_cond

bb_while_5_43_bre:                                ; preds = %bb_while_5_43_cond
  ret i32 0
}
