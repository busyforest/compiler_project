...
bb2:
  ...
  call void @foo(ptr %r119)
  %r120 = getelementptr [10 x %Bar], ptr %r104, i32 0, i32 0
  %r121 = getelementptr %Bar, ptr %r120, i32 0, i32 0
  %r122 = getelementptr %Node, ptr %r121, i32 0, i32 0
  %r123 = load i32, ptr %r122, align 4
  call void @putint(i32 %r123)
  %r124 = getelementptr [10 x %Bar], ptr %r104, i32 0, i32 0
  %r125 = getelementptr %Bar, ptr %r124, i32 0, i32 0
  %r126 = getelementptr %Node, ptr %r125, i32 0, i32 1
  %r127 = load i32, ptr %r126, align 4
  call void @putint(i32 %r127)
  %r128 = getelementptr [10 x %Bar], ptr %r104, i32 0, i32 0
  %r129 = getelementptr %Bar, ptr %r128, i32 0, i32 1
  %r130 = getelementptr [10 x %Node], ptr %r129, i32 0, i32 2
  %r131 = getelementptr %Node, ptr %r130, i32 0, i32 0
  %r132 = load i32, ptr %r131, align 4
  call void @putint(i32 %r132)
  %r133 = getelementptr [10 x %Bar], ptr %r104, i32 0, i32 0
  %r134 = getelementptr %Bar, ptr %r133, i32 0, i32 1
  %r135 = getelementptr [10 x %Node], ptr %r134, i32 0, i32 2
  %r136 = getelementptr %Node, ptr %r135, i32 0, i32 1
  %r137 = load i32, ptr %r136, align 4
  call void @putint(i32 %r137)
  %r138 = getelementptr [10 x %Bar], ptr %r104, i32 0, i32 1
  %r139 = getelementptr %Bar, ptr %r138, i32 0, i32 2
  %r140 = getelementptr [10 x i32], ptr %r139, i32 0, i32 3
