...
bb22_16_next:                                     ; preds = %bb_while_5_16_cond
  %r110 = load i32, ptr %r103, align 4
  %r111 = load i32, ptr @N, align 4
  %r112 = icmp slt i32 %r110, %r111
  br i1 %r112, label %bb_while_5_16_whilestms, label %bb_while_5_16_bre

bb_while_5_16_whilestms:                          ; preds = %bb22_16_next
  %r113 = load i32, ptr %r103, align 4
  %r114 = add i32 %r113, 1
  store i32 %r114, ptr %r103, align 4
  br label %bb_while_5_16_cond

bb_while_5_16_bre:                                ; preds = %bb22_16_next, %bb_while_5_16_cond
  %r115 = load i32, ptr @N, align 4
  store i32 %r115, ptr %r104, align 4
  br label %bb_while_5_22_cond

bb_while_5_22_cond:                               ; preds = %bb_while_5_22_whilestms, %bb_while_5_16_bre
  %r116 = load i32, ptr %r104, align 4
  %r117 = load i32, ptr %r103, align 4
...
bb_while_5_22_whilestms:                          ; preds = %bb_while_5_22_cond
  %r120 = load i32, ptr %r104, align 4
  %r121 = sub i32 %r120, 1
  store i32 %r121, ptr %r119, align 4
  %r122 = load i32, ptr %r104, align 4
  %r123 = getelementptr i32, ptr %r100, i32 %r122
  %r124 = load i32, ptr %r119, align 4
  %r125 = getelementptr i32, ptr %r100, i32 %r124
  ...
  %r129 = load i32, ptr %r102, align 4
  store i32 %r129, ptr %r128, align 4
  %r130 = load i32, ptr %r104, align 4
  %r131 = sub i32 %r130, 1
  store i32 %r131, ptr %r104, align 4
  br label %bb_while_5_22_cond
...
bb2:
  ...
  store i32 0, ptr %r144, align 4
  %r145 = call i32 @getint()
  store i32 %r145, ptr %r143, align 4
  %r146 = getelementptr [11 x i32], ptr %r132, i32 0, i32 0
  %r147 = load i32, ptr %r143, align 4
  %r148 = call i32 @insert(ptr %r146, i32 %r147)
  store i32 %r148, ptr %r143, align 4
  br label %bb_while_5_54_cond

bb_while_5_54_cond:                               ; preds = %bb_while_5_54_whilestms, %bb2
  %r149 = load i32, ptr %r144, align 4
...
bb_while_5_54_whilestms:                          ; preds = %bb_while_5_54_cond
  %r152 = load i32, ptr %r144, align 4
  %r153 = getelementptr [11 x i32], ptr %r132, i32 0, i32 %r152
  %r154 = load i32, ptr %r153, align 4
  store i32 %r154, ptr %r143, align 4
  %r155 = load i32, ptr %r143, align 4
  call void @putint(i32 %r155)
  store i32 10, ptr %r143, align 4
  %r156 = load i32, ptr %r143, align 4
  call void @putch(i32 %r156)
  %r157 = load i32, ptr %r144, align 4
  %r158 = add i32 %r157, 1
  store i32 %r158, ptr %r144, align 4
  br label %bb_while_5_54_cond
