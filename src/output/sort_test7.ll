...
bb_while_5_23_cond:                               ; preds = %bb_while_5_23_whilestms, %bb1
  %r121 = load i32, ptr %r118, align 4
  %r122 = load i32, ptr %r107, align 4
  %r123 = icmp slt i32 %r121, %r122
  br i1 %r123, label %bb_while_5_23_whilestms, label %bb_while_5_23_bre

bb_while_5_23_whilestms:                          ; preds = %bb_while_5_23_cond
...
bb_while_5_23_bre:                                ; preds = %bb_while_5_23_cond
  br label %bb_while_5_28_cond

bb_while_5_28_cond:                               ; preds = %bb_while_5_28_whilestms, %bb_while_5_23_bre
  %r134 = load i32, ptr %r119, align 4
  %r135 = load i32, ptr %r112, align 4
  %r136 = icmp slt i32 %r134, %r135
  br i1 %r136, label %bb_while_5_28_whilestms, label %bb_while_5_28_bre
...
bb_while_5_37_cond:                               ; preds = %bb_if_9_39_end, %bb_while_5_28_bre
  %r150 = load i32, ptr %r118, align 4
  %r151 = load i32, ptr %r107, align 4
  %r152 = icmp ne i32 %r150, %r151
  br i1 %r152, label %bb23_37_next, label %bb_while_5_37_bre

bb23_37_next:                                     ; preds = %bb_while_5_37_cond
  %r153 = load i32, ptr %r119, align 4
  %r154 = load i32, ptr %r112, align 4
  %r155 = icmp ne i32 %r153, %r154
  br i1 %r155, label %bb_while_5_37_whilestms, label %bb_while_5_37_bre

bb_while_5_37_whilestms:                          ; preds = %bb23_37_next
  ...
  br i1 %r163, label %bb_if_9_39_true, label %bb_if_9_39_false

bb_if_9_39_true:                                  ; preds = %bb_while_5_37_whilestms
  ...
  br label %bb_if_9_39_end

bb_if_9_39_false:                                 ; preds = %bb_while_5_37_whilestms
...
bb_if_9_39_end:                                   ; preds = %bb_if_9_39_false, %bb_if_9_39_true
  br label %bb_while_5_37_cond

bb_while_5_37_bre:                                ; preds = %bb23_37_next, %bb_while_5_37_cond
  br label %bb_while_5_50_cond

bb_while_5_50_cond:                               ; preds = %bb_while_5_50_whilestms, %bb_while_5_37_bre
  %r182 = load i32, ptr %r118, align 4
  %r183 = load i32, ptr %r107, align 4
  %r184 = icmp slt i32 %r182, %r183
  br i1 %r184, label %bb_while_5_50_whilestms, label %bb_while_5_50_bre

bb_while_5_50_whilestms:                          ; preds = %bb_while_5_50_cond
...
bb_while_5_50_bre:                                ; preds = %bb_while_5_50_cond
  br label %bb_while_5_55_cond

bb_while_5_55_cond:                               ; preds = %bb_while_5_55_whilestms, %bb_while_5_50_bre
  %r194 = load i32, ptr %r119, align 4
  %r195 = load i32, ptr %r112, align 4
  %r196 = icmp slt i32 %r194, %r195
  br i1 %r196, label %bb_while_5_55_whilestms, label %bb_while_5_55_bre

bb_while_5_55_whilestms:                          ; preds = %bb_while_5_55_cond
...
bb_while_5_55_bre:                                ; preds = %bb_while_5_55_cond
  ret i32 0
}
...
bb2:
  ...
  br i1 %r213, label %bb_if_5_65_true, label %bb_if_5_65_false

bb_if_5_65_true:                                  ; preds = %bb2
  ...
  br label %bb_if_5_65_end

bb_if_5_65_false:                                 ; preds = %bb2
  br label %bb_if_5_65_end

bb_if_5_65_end:                                   ; preds = %bb_if_5_65_false, %bb_if_5_65_true
  ret i32 0
}
...
bb_while_5_88_cond:                               ; preds = %bb_while_5_88_whilestms, %bb3
  %r251 = load i32, ptr %r243, align 4
  %r252 = load i32, ptr @n, align 4
  %r253 = icmp slt i32 %r251, %r252
  br i1 %r253, label %bb_while_5_88_whilestms, label %bb_while_5_88_bre
...
bb_while_5_88_bre:                                ; preds = %bb_while_5_88_cond
  ret i32 0
}
