...
bb_while_5_22_cond:                               ; preds = %bb_if_9_26_end, %bb2
  %r128 = load i32, ptr %r124, align 4
  %r129 = load i32, ptr %r121, align 4
  %r130 = add i32 %r129, 1
  %r131 = icmp slt i32 %r128, %r130
  br i1 %r131, label %bb_while_5_22_whilestms, label %bb_while_5_22_bre
...
bb_while_5_22_whilestms:                          ; preds = %bb_while_5_22_cond
  ...
  br i1 %r137, label %bb29_24_next, label %bb_if_9_24_false

bb29_24_next:                                     ; preds = %bb_while_5_22_whilestms
  ...
  br i1 %r144, label %bb_if_9_24_true, label %bb_if_9_24_false

bb_if_9_24_true:                                  ; preds = %bb29_24_next
  %r145 = load i32, ptr %r124, align 4
  %r146 = add i32 %r145, 1
  store i32 %r146, ptr %r124, align 4
  br label %bb_if_9_24_end

bb_if_9_24_false:                                 ; preds = %bb29_24_next, %bb_while_5_22_whilestms
  br label %bb_if_9_24_end

bb_if_9_24_end:                                   ; preds = %bb_if_9_24_false, %bb_if_9_24_true
  ...
  br i1 %r153, label %bb_if_9_26_true, label %bb_if_9_26_false

bb_if_9_26_true:                                  ; preds = %bb_if_9_24_end
  ret i32 0

bb_if_9_26_false:                                 ; preds = %bb_if_9_24_end
  ...
  br label %bb_if_9_26_end

bb_if_9_26_end:                                   ; preds = %bb_if_9_26_false
  br label %bb_while_5_22_cond
...
bb_while_5_40_cond:                               ; preds = %bb_while_5_40_whilestms, %bb3
  %r169 = load i32, ptr %r164, align 4
  %r170 = sub i32 0, 1
  %r171 = icmp sgt i32 %r169, %r170
  br i1 %r171, label %bb_while_5_40_whilestms, label %bb_while_5_40_bre

bb_while_5_40_whilestms:                          ; preds = %bb_while_5_40_cond
...
bb_while_5_40_bre:                                ; preds = %bb_while_5_40_cond
  %r179 = load i32, ptr %r163, align 4
  %r180 = sub i32 %r179, 1
  store i32 %r180, ptr %r164, align 4
  br label %bb_while_5_46_cond

bb_while_5_46_cond:                               ; preds = %bb_while_5_46_whilestms, %bb_while_5_40_bre
  %r181 = load i32, ptr %r164, align 4
  %r182 = icmp sgt i32 %r181, 0
  br i1 %r182, label %bb_while_5_46_whilestms, label %bb_while_5_46_bre
...
bb4:
  ...
  %r206 = getelementptr [10 x i32], ptr %r194, i32 0, i32 0
  %r207 = load i32, ptr @n, align 4
  %r208 = call i32 @heap_sort(ptr %r206, i32 %r207)
  store i32 %r208, ptr %r205, align 4
  br label %bb_while_5_65_cond

bb_while_5_65_cond:                               ; preds = %bb_while_5_65_whilestms, %bb4
  %r209 = load i32, ptr %r205, align 4
  %r210 = load i32, ptr @n, align 4
  %r211 = icmp slt i32 %r209, %r210
  br i1 %r211, label %bb_while_5_65_whilestms, label %bb_while_5_65_bre

bb_while_5_65_whilestms:                          ; preds = %bb_while_5_65_cond
  %r213 = load i32, ptr %r205, align 4
  %r214 = getelementptr [10 x i32], ptr %r194, i32 0, i32 %r213
  ...
  %r218 = load i32, ptr %r205, align 4
  %r219 = add i32 %r218, 1
  store i32 %r219, ptr %r205, align 4
  br label %bb_while_5_65_cond

bb_while_5_65_bre:                                ; preds = %bb_while_5_65_cond
  ret i32 0
}
