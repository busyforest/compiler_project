...
bb_while_5_20_cond:                               ; preds = %bb_while_5_20_whilestms, %bb2
  %r116 = load i32, ptr %r114, align 4
  %r117 = icmp slt i32 %r116, 4
  br i1 %r117, label %bb_while_5_20_whilestms, label %bb_while_5_20_bre

bb_while_5_20_whilestms:                          ; preds = %bb_while_5_20_cond
  %r118 = load i32, ptr %r114, align 4
  %r119 = getelementptr [4 x i32], ptr %r113, i32 0, i32 %r118
...
bb_while_5_20_bre:                                ; preds = %bb_while_5_20_cond
  ...
  br i1 %r130, label %bb25_27_next, label %bb_if_5_27_false

bb25_27_next:                                     ; preds = %bb_while_5_20_bre
  ...
  br i1 %r135, label %bb_if_5_27_true, label %bb_if_5_27_false

bb_if_5_27_true:                                  ; preds = %bb25_27_next
  store i32 1, ptr %r115, align 4
  br label %bb_if_5_27_end

bb_if_5_27_false:                                 ; preds = %bb25_27_next, %bb_while_5_20_bre
  store i32 0, ptr %r115, align 4
  br label %bb_if_5_27_end

bb_if_5_27_end:                                   ; preds = %bb_if_5_27_false, %bb_if_5_27_true
  %r136 = load i32, ptr %r115, align 4
  ret i32 %r136
}
...
bb3:
  ...
  store i32 1221, ptr %r137, align 4
  %r138 = alloca i32, align 4
  %r139 = load i32, ptr %r137, align 4
  %r140 = call i32 @palindrome(i32 %r139)
  store i32 %r140, ptr %r138, align 4
  %r141 = load i32, ptr %r138, align 4
  %r142 = icmp eq i32 %r141, 1
  br i1 %r142, label %bb_if_5_42_true, label %bb_if_5_42_false

bb_if_5_42_true:                                  ; preds = %bb3
  %r143 = load i32, ptr %r137, align 4
  call void @putint(i32 %r143)
  br label %bb_if_5_42_end

bb_if_5_42_false:                                 ; preds = %bb3
  store i32 0, ptr %r138, align 4
  %r144 = load i32, ptr %r138, align 4
  call void @putint(i32 %r144)
  br label %bb_if_5_42_end

bb_if_5_42_end:                                   ; preds = %bb_if_5_42_false, %bb_if_5_42_true
  store i32 10, ptr %r138, align 4
