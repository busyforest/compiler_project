...
bb21_10_next:                                     ; preds = %bb1
  %r106 = load i32, ptr %r103, align 4
  %r107 = icmp eq i32 %r106, 1
  br i1 %r107, label %bb_if_5_10_true, label %bb_if_5_10_false

bb_if_5_10_true:                                  ; preds = %bb21_10_next, %bb1
  ret i32 1

bb_if_5_10_false:                                 ; preds = %bb21_10_next
  br label %bb_if_5_10_end

bb_if_5_10_end:                                   ; preds = %bb_if_5_10_false
  store i32 0, ptr %r109, align 4
  br label %bb_while_5_22_cond

bb_while_5_22_cond:                               ; preds = %bb_while_5_22_whilestms, %bb_if_5_10_end
...
bb_while_5_22_whilestms:                          ; preds = %bb_while_5_22_cond
  %r117 = load i32, ptr %r109, align 4
  %r118 = mul i32 %r117, 3
  %r119 = load i32, ptr %r103, align 4
  %r120 = add i32 %r118, %r119
  %r121 = sub i32 %r120, 1
  store i32 %r121, ptr %r111, align 4
  %r122 = load i32, ptr %r111, align 4
  %r123 = getelementptr [9 x i32], ptr %r108, i32 0, i32 %r122
  store i32 1, ptr %r123, align 4
  %r124 = load i32, ptr %r109, align 4
  %r125 = add i32 %r124, 1
  store i32 %r125, ptr %r109, align 4
  br label %bb_while_5_22_cond

bb_while_5_22_bre:                                ; preds = %bb_while_5_22_cond
  store i32 0, ptr %r109, align 4
  br label %bb_while_5_28_cond

bb_while_5_28_cond:                               ; preds = %bb_while_5_28_whilestms, %bb_while_5_22_bre
  %r126 = load i32, ptr %r109, align 4
  %r127 = load i32, ptr %r103, align 4
  %r128 = icmp slt i32 %r126, %r127
  br i1 %r128, label %bb_while_5_28_whilestms, label %bb_while_5_28_bre

bb_while_5_28_whilestms:                          ; preds = %bb_while_5_28_cond
  %r129 = load i32, ptr %r101, align 4
  %r130 = sub i32 %r129, 1
  %r131 = mul i32 %r130, 3
  %r132 = load i32, ptr %r109, align 4
  %r133 = add i32 %r131, %r132
  store i32 %r133, ptr %r111, align 4
  %r134 = load i32, ptr %r111, align 4
  %r135 = getelementptr [9 x i32], ptr %r108, i32 0, i32 %r134
  store i32 1, ptr %r135, align 4
  %r136 = load i32, ptr %r109, align 4
  %r137 = add i32 %r136, 1
  store i32 %r137, ptr %r109, align 4
  br label %bb_while_5_28_cond

bb_while_5_28_bre:                                ; preds = %bb_while_5_28_cond
  %r138 = load i32, ptr %r101, align 4
  %r139 = sub i32 %r138, 2
  store i32 %r139, ptr %r109, align 4
  br label %bb_while_5_34_cond

bb_while_5_34_cond:                               ; preds = %bb_while_9_36_bre, %bb_while_5_28_bre
  %r140 = load i32, ptr %r109, align 4
  %r141 = sub i32 0, 1
...
bb_while_5_34_whilestms:                          ; preds = %bb_while_5_34_cond
  %r143 = load i32, ptr %r103, align 4
  %r144 = sub i32 %r143, 2
  store i32 %r144, ptr %r110, align 4
  br label %bb_while_9_36_cond

bb_while_9_36_cond:                               ; preds = %bb_while_9_36_whilestms, %bb_while_5_34_whilestms
  %r145 = load i32, ptr %r110, align 4
  %r146 = sub i32 0, 1
  %r147 = icmp sgt i32 %r145, %r146
  br i1 %r147, label %bb_while_9_36_whilestms, label %bb_while_9_36_bre

bb_while_9_36_whilestms:                          ; preds = %bb_while_9_36_cond
  %r148 = load i32, ptr %r109, align 4
  %r149 = mul i32 %r148, 3
  %r150 = load i32, ptr %r110, align 4
  %r151 = add i32 %r149, %r150
  store i32 %r151, ptr %r111, align 4
  %r152 = load i32, ptr %r109, align 4
  %r153 = add i32 %r152, 1
  %r154 = mul i32 %r153, 3
  %r155 = load i32, ptr %r110, align 4
  %r156 = add i32 %r154, %r155
  store i32 %r156, ptr %r112, align 4
  %r157 = load i32, ptr %r109, align 4
  %r158 = mul i32 %r157, 3
  %r159 = load i32, ptr %r110, align 4
  %r160 = add i32 %r158, %r159
  %r161 = add i32 %r160, 1
  store i32 %r161, ptr %r113, align 4
  %r162 = load i32, ptr %r111, align 4
  %r163 = getelementptr [9 x i32], ptr %r108, i32 0, i32 %r162
  %r164 = load i32, ptr %r112, align 4
  %r165 = getelementptr [9 x i32], ptr %r108, i32 0, i32 %r164
  %r166 = load i32, ptr %r165, align 4
  %r167 = load i32, ptr %r113, align 4
  %r168 = getelementptr [9 x i32], ptr %r108, i32 0, i32 %r167
  %r169 = load i32, ptr %r168, align 4
  %r170 = add i32 %r166, %r169
  store i32 %r170, ptr %r163, align 4
  %r171 = load i32, ptr %r110, align 4
  %r172 = sub i32 %r171, 1
  store i32 %r172, ptr %r110, align 4
  br label %bb_while_9_36_cond

bb_while_9_36_bre:                                ; preds = %bb_while_9_36_cond
  %r173 = load i32, ptr %r109, align 4
  %r174 = sub i32 %r173, 1
  store i32 %r174, ptr %r109, align 4
  br label %bb_while_5_34_cond
...
bb2:
  ...
  store i32 3, ptr %r178, align 4
  %r179 = load i32, ptr %r178, align 4
  %r180 = load i32, ptr %r178, align 4
  %r181 = call i32 @uniquePaths(i32 %r179, i32 %r180)
  store i32 %r181, ptr %r177, align 4
  %r182 = load i32, ptr %r177, align 4
  ret i32 %r182
}
